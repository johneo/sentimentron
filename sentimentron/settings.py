...
SECRET_KEY = ')o0i5k8zehjsghb%-79&0+0m02qw6al3%1r@5-(6d#@cwgv-()'
...
# Load in all the secrets from the secrets file, this is not in git!
try:
    from sentimentron.secrets import *
except ImportError:
    pass
...
ROOT_URLCONF = 'sentimentron.urls'

# Python dotted path to the WSGI application used by Django's runserver.
WSGI_APPLICATION = 'sentimentron.wsgi.application'
